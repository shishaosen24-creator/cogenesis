...
export function CanvasNodeAngleDialog({ dataUrl, open, onClose, onConfirm }: { dataUrl: string; open: boolean; onClose: () => void; onConfirm: (params: CanvasImageAngleParams) => void }) {
    ...
    return (
        <Modal
            ...
            title={
                <div>
                    <div className="text-base font-semibold text-[color:var(--sacred-on-surface)]">AI 多角度</div>
                    <div className="mt-1 text-xs font-normal text-[color:var(--sacred-on-surface-variant)]">左侧只预览方向，结果会基于原图重新生成</div>
                </div>
            }
        ...
        >
            <div className="canvas-image-tool-shell space-y-5">
                <div className="grid gap-6 md:grid-cols-[minmax(260px,1fr)_360px]">
                    <div className="canvas-image-tool-preview sacred-panel-soft flex min-h-[300px] flex-col justify-between p-4">
                        <div className="grid flex-1 place-items-center">
                            <div className="relative">
                                ...
                                <div className="absolute -bottom-6 left-1/2 h-10 w-24 -translate-x-1/2 rounded-full border border-[rgba(233,193,118,0.24)] bg-black/25 backdrop-blur" />
                            </div>
                        </div>
                    ...
                    <div className="canvas-image-tool-side space-y-6 py-2">
                        ...
                        <div className="canvas-image-tool-control grid grid-cols-[88px_1fr_72px] items-center gap-4">
